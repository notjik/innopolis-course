...
try:
    WEBHOOK_HOST = os.getenv('WEBHOOK_HOST_SIXTH')
    WEBHOOK_PATH = os.getenv('WEBHOOK_PATH_SIXTH')
    WEBHOOK_URL = WEBHOOK_HOST + WEBHOOK_PATH
    WEBAPP_HOST = os.getenv('WEBAPP_HOST_SIXTH')
    WEBAPP_PORT = os.getenv('WEBAPP_PORT_SIXTH')
    bot = Bot(token=os.getenv('TOKEN_SIXTH'))
except TypeError:
