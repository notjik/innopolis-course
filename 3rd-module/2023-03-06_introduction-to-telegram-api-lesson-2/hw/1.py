"""
Реализовать эхо бота с использование Telegram bot api.
"""
...
async def start_message(msg: types.Message):
    ...
    :return: answer
    """
    await msg.answer("Hi! Welcome to the bot from the third assignment of the Innopolis University course.\n"
